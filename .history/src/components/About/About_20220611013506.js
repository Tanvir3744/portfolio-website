            ...
            <div class="hero min-h-screen bg-base-200 rounded">
                <div class="max-w-7xl mx-auto  hero-content flex-col lg:flex-row-reverse px-12">
                    ...
                    <div className='px-6'>
                        ...
                        <p class="py-2 ">Passionate about implementing and launching new project. I have enough ability to translate business requirements in to technical solution. Looking for start career as a frontend developer with a reputed firm with driven technology.</p>
                    </div>
                </div>
            </div>
        </div>
