...
const Serivces = () => {
    ...
    return (
        <div className='mt-12 mb-8'>
            <div className=' grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-8  gap-5 bg-base-200  px-4 lg:px-12'>
                {
                    serviceData.map(service =>
                        <div class="mb-8 card w-96 bg-base-100 shadow-xl max-w-7xl mx-auto mt-10">
