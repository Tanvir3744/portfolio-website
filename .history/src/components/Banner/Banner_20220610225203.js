            ...
            <div class="hero min-h-screen ">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div className='px-12'>
                        ...
                        <p data-aos='fade-left' class="py-6">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
                        <button class="btn btn-error text-lg text-white font-semibold">
                            Download CV
