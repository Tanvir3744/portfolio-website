            ...
            <div class="hero min-h-screen ">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div className='px-12'>
                        ...
                        <p data-aos='fade-left' data-aos-duration='2100' class="py-6">I am a professional website developer . I work with new trending javascript library reactjs and I combined node.js express.js and mongodb to make a greate web applicaton. </p>
